const listaDeCertificados = [
    {
        ...
        descricao:
            "Curso prático de introdução à programação utilizando a linguagem Python, focado no desenvolvimento de raciocínio lógico, algoritmos e conceitos fundamentais de ciência da computação. Ministrado pelo instrutor Diego Mariano (Ph.D. pela UFMG).",
    ...
    },
    {
        ...
        descricao:
            "Entender a base de como o hardware se comunica com o software é essencial para construir soluções melhores e mais eficientes na área de desenvolvimento.",
    ...
    },
    {
        ...
        descricao:
            "Curso autoinstrucional sobre os fundamentos, pilares e aplicações práticas da Lei Geral de Proteção de Dados (Lei nº 13.709/2018), focado nos direitos dos titulares, tratamento de dados pessoais e boas práticas de segurança da informação no desenvolvimento e gestão de sistemas.",
    ...
    },
    {
        ...
        descricao:
            "Curso de 8 horas abrangendo os conceitos essenciais e fundamentos da linguagem Python. Desenvolvimento de competências em estruturas de dados, controle de fluxo e lógica aplicada, validados por módulos práticos e autoavaliação da plataforma Santander Open Academy.",
